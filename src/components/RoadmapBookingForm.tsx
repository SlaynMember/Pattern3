...
const RoadmapBookingForm = () => {
  ...
  if (submitStatus === 'success') {
    return (
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
  ...
  return (
    <div id="roadmap-booking-form" className="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8">
...
export default RoadmapBookingForm;